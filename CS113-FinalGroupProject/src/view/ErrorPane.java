...
public class ErrorPane extends JFrame
{
    ...
    {
        picture("resources/ErrorPane/confetti.gif", "", "", true);
    }
    ...
    {
        picture("resources/ErrorPane/moneyRain.gif", "", "", true);
    }
    ...
    {
        picture("resources/ErrorPane/rickroll.GIF", "resources/ErrorPane/rickroll.wav", headerMessage, false);
    }
    ...
    {
        picture("resources/ErrorPane/rickroll.GIF", "resources/ErrorPane/rickroll.wav", "Error", false);
    }

    /*##############################################################################*
     *######## JohnCena Error with standard or customizable header Message #########*
     *##############################################################################*/
    ...
    {
        picture("resources/ErrorPane/johnCena.GIF", "resources/ErrorPane/johnCena.wav", headerMessage, false);
    }
    ...
    {
        picture("resources/ErrorPane/johnCena.GIF", "resources/ErrorPane/johnCena.wav", "Error", false);
    }
