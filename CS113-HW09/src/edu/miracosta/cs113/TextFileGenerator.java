 ...
 * @git julianbeaulieu
 * @version 2.0
 * @description Class which scrapes a website and then saves it as a txt file
 */
...
public class TextFileGenerator {
    ...
    public static String cleanString(String unParsed) {
        ...
        for(int i = 0; i < preRinse(unParsed).length(); i++) {
            current = preRinse(unParsed).charAt(i);
    ...
    public static String preRinse(String input)
    {
      boolean open = false;
